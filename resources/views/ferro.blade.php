...
<body class="sub_page">
    ...
    <div class="container-fluid page-header2 mb-5 py-5">
        <div class="container">
          <h1 class="display-3 text-white mb-3 ">Ferro Alloy</h1>
                ...
                <div class="portfolio-details">
                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-12 col-md-12">
                      <div class="owl-carousel no-pb" data-dots="false"
                        data-nav="true" data-items="1"
                        data-autoplay="true">
                        <div class="item">
                          <img class="img-fluid w-100"
                            src="images/portfolio/iron (1).jpg" alt>
                        </div>
                        <div class="item">
                          <img class="img-fluid w-100"
                            src="images/portfolio/make1.jpg" alt>
                        </div>
                        <div class="item">
                          <img class="img-fluid w-100"
                            src="images/portfolio/make2.jpg" alt>
                        </div>
                        <div class="item">
                          <img class="img-fluid w-100"
                            src="images/portfolio/make3.jpg" alt>
                        </div>
                  ...
                  <div class="row mt-4">
                    <div class="col-md-12">
                      <div class="section-title mb-3">
                        <h2 class="title">Ferro<span> Alloy</span></h2>
                      </div>
                  ...
                  <div class="row box-shadow mt-5">
                    <div class="col-lg-6 col-md-12 px-5 py-5">
                      <h4 class="title">About <span>Steel Management </span>Ferro
                        Alloy</h4>
                    ...
                    <div class="col-lg-6 col-md-12 dark-bg px-5 py-5">
                      <img style="width:100%;height:100%;" src="{{ asset('frontend/assets/images/ferro4.jpg')}}"
                        alt>
                    </div>
                  </div>
                  <div class="row box-shadow mt-10">
                    ...
                    <div class="col-lg-6 col-md-12 dark-bg px-5 py-5">
                      ...
                      <img style="width:100%;height:100%;" src="{{ asset('frontend/assets/images/ferro5.jpg')}}"
                        alt>
