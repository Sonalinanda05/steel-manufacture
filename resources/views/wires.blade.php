...
<body class="sub_page">
    ...
    <div class="container-fluid page-header4 mb-5 py-5">
        <div class="container">
            <h1 class="display-3 text-white mb-3 ">Wire Rods</h1>
                        ...
                        <div class="portfolio-details">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="section-title mb-3">
                                        <h2 class="title">Wire<span> Rods</span></h2>
                                    </div>
                            ...
                            <div class="row box-shadow mt-5">
                                <div class="col-lg-6 col-md-12 px-5 py-5">
                                    <h4 class="title">About <span>Steel Management </span>Wire
                                        Rods </h4>
                                ...
                                <div class="col-lg-6 col-md-12 dark-bg px-5 py-5">
                                    <img style="width:100%;height:100%;" src="{{ asset('frontend/assets/images/wire1.jpg')}}" alt>
                                </div>
                            </div>
                            <div class="row box-shadow mt-10">
                                ...
                                <div class="col-lg-6 col-md-12 dark-bg px-5 py-5">
                                    ...
                                    <img style="width:100%;height:100%;" src="{{ asset('frontend/assets/images/wire9.jpg')}}" alt>
